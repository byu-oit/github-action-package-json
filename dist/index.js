...
const setters_1 = __importDefault(__nccwpck_require__(1253));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const content = fs_1.readFileSync(file, { encoding: 'utf-8' });
            const pkg = JSON.parse(content);
            const mods = Object.keys(setters_1.default);
            try {
                for (const mod of mods) {
                    const invoke = core.getInput(mod, { required: false }) === 'true';
                    if (invoke)
                        setters_1.default[mod](pkg);
                }
            }
            catch (e) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const version_1 = __nccwpck_require__(5686);
const setters = {
    version: version_1.version
};
exports.default = setters;
